...
export function DischargeTab() {
  ...
  const dischargeSummary = {
    en: {
      ...
      summary:
        "Patient was admitted with chief complaints of fever, cough, and breathing difficulty. Clinical examination revealed bilateral crackles in lungs. Chest X-ray showed mild pneumonic consolidation. Treated with antibiotics and supportive care. Patient showed improvement and is fit for discharge.",
      medications: [
      ...
      followUp:
        "Follow-up consultation in 1 week. Repeat chest X-ray if symptoms persist.",
    ...
    hi: {
      ...
      summary:
        "रोगी बुखार, खांसी और सांस लेने में कठिनाई की शिकायत के साथ भर्ती हुए। नैदानिक परीक्षण से फेफड़ों में द्विपक्षीय क्रैकल्स पाए गए। छाती का एक्स-रे हल्के निमोनिक संघनन को दिखाता है। एंटीबायोटिक्स और सहायक देखभाल से इलाज किया गया। रोगी में सुधार हुआ है और छुट्टी के लिए तैयार है।",
      medications: [
      ...
      followUp:
        "1 हफ्ते में फॉलो-अप परामर्श। अगर लक्षण बने रहें तो छाती का एक्स-रे दोहराएं।",
    ...
    <div className="space-y-4">
      ...
      <Card className="p-8 print:p-0">
        ...
        <div className="grid grid-cols-2 gap-6 mb-8 pb-8 border-b border-border">
          ...
          <div>
            <p className="text-xs font-semibold text-muted-foreground">UHID</p>
            <p className="text-base font-mono text-teal-600">{content.uhid}</p>
          </div>
          <div>
            <p className="text-xs font-semibold text-muted-foreground">
