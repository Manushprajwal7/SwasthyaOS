...
export function Sidebar({ isOpen, onToggle, userRole, currentPage }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Bottom Section */}
      <div className={cn('border-t border-border px-3 py-4', !isOpen && 'flex flex-col items-center')}>
